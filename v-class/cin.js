...
//https://www.google.com.tw/#q=javascript+String.fromCodePoint
		...
		newInstance: function() {
			var obj = {
				...
				readFile: function(path) {
					...
					try {
					    let [ok, text] = GLib.file_get_contents(path);
					    if (!ok) {
					    ...
					    print('Error readFile: ', e.message);
						System.exit(1);
					}
		...
		newInstance: function() {
			var obj = {
				...
				run: function() {
					...
					//print(this._UnicodeCnsCollision);
				...
				logUnicodeCollision: function() {
					var rtn = '';
					rtn += this.makLine_Csv_Head();
					//print(this._UnicodePhoneticCollision)
